...
export const CUSTOMERS: Customer[] = [
  ...
  { id: 'cust12', name: 'Daniel Jackson', phone: '(562) 555-1012', email: 'djackson@email.com',
    ...
    city: 'Long Beach', preferredCleanerIds: [], jobHistory: ['j14'],
    source: 'yelp', notes: 'New customer. Studio apartment.', totalSpent: 115, createdAt: '2025-04-20' },
  { id: 'cust13', name: 'Tanya Reyes', phone: '(310) 555-1013', email: 'treyes@email.com',
    ...
    city: 'Inglewood', preferredCleanerIds: ['c5', 'c6'], jobHistory: ['j18'],
    source: 'facebook', notes: 'New customer via FB group.', totalSpent: 165, createdAt: '2026-04-20' },
  ...
  { id: 'cust15', name: 'Sandra Nguyen', phone: '(562) 555-1015', email: 'snguyen@email.com',
    ...
    city: 'Bellflower', preferredCleanerIds: ['c9', 'c10'], jobHistory: ['j23'],
    source: 'yelp', notes: 'First deep clean. 3BD/2BA.', totalSpent: 245, createdAt: '2026-04-18' },
  ...
  // ── Nurturing campaign demo customers ── last jobs 21-42 days ago ───────────
  { id: 'cust17', name: 'Grace Okafor', phone: '(562) 555-1017', email: 'grace.o@email.com',
    address: '2810 E 4th St, Long Beach, CA 90814', lat: 33.769, lng: -118.157,
    city: 'Long Beach', preferredCleanerIds: ['c1', 'c2'], jobHistory: ['j25'],
    source: 'facebook', notes: '3BD/2BA. Has a toddler — safe products only.', totalSpent: 355, createdAt: '2025-11-10' },
  { id: 'cust18', name: 'Brendan Walsh', phone: '(310) 555-1018', email: 'bwalsh@email.com',
    address: '1612 Cabrillo Ave, Torrance, CA 90501', lat: 33.836, lng: -118.312,
    city: 'Torrance', preferredCleanerIds: ['c3', 'c4'], jobHistory: ['j26'],
    source: 'yelp', notes: 'Condo. Prefers afternoon appointments.', totalSpent: 480, createdAt: '2025-09-22' },
  { id: 'cust19', name: 'Elena Vasquez', phone: '(323) 555-1019', email: 'evasquez@email.com',
    address: '6220 S Western Ave, Gardena, CA 90047', lat: 33.939, lng: -118.309,
    city: 'Gardena', preferredCleanerIds: ['c5', 'c6'], jobHistory: ['j27'],
    source: 'referral', notes: 'Monthly deep clean. Large 4BD.', totalSpent: 715, createdAt: '2025-06-15' },
  { id: 'cust20', name: 'Thomas Kim', phone: '(310) 555-1020', email: 'tkim@email.com',
    address: '3401 Sepulveda Blvd, Manhattan Beach, CA 90266', lat: 33.878, lng: -118.377,
    city: 'Manhattan Beach', preferredCleanerIds: ['c3'], jobHistory: ['j28'],
    source: 'repeat', notes: 'Bi-weekly. Very tidy, just wants maintenance clean.', totalSpent: 1320, createdAt: '2024-08-01' },
  { id: 'cust21', name: 'Patricia Moore', phone: '(310) 555-1021', email: 'pmoore@email.com',
    address: '520 W Imperial Hwy, Hawthorne, CA 90250', lat: 33.922, lng: -118.341,
    city: 'Hawthorne', preferredCleanerIds: ['c7', 'c8'], jobHistory: ['j29'],
    source: 'facebook', notes: 'Has allergies — unscented products only.', totalSpent: 260, createdAt: '2026-01-30' },
  { id: 'cust22', name: 'Derek Oluwafemi', phone: '(562) 555-1022', email: 'doluwafemi@email.com',
    address: '11400 Del Amo Blvd, Lakewood, CA 90715', lat: 33.845, lng: -118.093,
    city: 'Lakewood', preferredCleanerIds: ['c9', 'c10'], jobHistory: ['j30'],
    source: 'text', notes: 'Airbnb host. Needs quick turnaround between guests.', totalSpent: 530, createdAt: '2025-10-05' },
  { id: 'cust23', name: 'Mia Fontaine', phone: '(310) 555-1023', email: 'mia.f@email.com',
    address: '401 N Pacific Coast Hwy, Redondo Beach, CA 90277', lat: 33.856, lng: -118.388,
    city: 'Redondo Beach', preferredCleanerIds: ['c3', 'c4'], jobHistory: ['j31'],
    source: 'facebook', notes: 'Beach condo. Has a dog.', totalSpent: 395, createdAt: '2025-07-19' },
]
...
export const JOBS: Job[] = [
  ...
  // ── Nurturing campaign demo — completed jobs 21-42 days ago ─────────────────
  { id: 'j25', customerId: 'cust17', cleanerIds: ['c1', 'c2'],
    scheduledDate: fmt(addDays(today, -21)), scheduledTime: '09:00', estimatedDuration: 150,
    status: 'completed', serviceType: 'standard', price: 165, paid: true, paymentMethod: 'zelle',
    address: '2810 E 4th St, Long Beach, CA 90814', lat: 33.769, lng: -118.157,
    notes: '', driveTimeMinutes: 9, createdAt: fmt(addDays(today, -25)) },
  { id: 'j26', customerId: 'cust18', cleanerIds: ['c3', 'c4'],
    scheduledDate: fmt(addDays(today, -28)), scheduledTime: '10:00', estimatedDuration: 150,
    status: 'completed', serviceType: 'standard', price: 145, paid: true, paymentMethod: 'venmo',
    address: '1612 Cabrillo Ave, Torrance, CA 90501', lat: 33.836, lng: -118.312,
    notes: '', driveTimeMinutes: 11, createdAt: fmt(addDays(today, -32)) },
  { id: 'j27', customerId: 'cust19', cleanerIds: ['c5', 'c6'],
    scheduledDate: fmt(addDays(today, -38)), scheduledTime: '08:30', estimatedDuration: 240,
    status: 'completed', serviceType: 'deep', price: 275, paid: true, paymentMethod: 'zelle',
    address: '6220 S Western Ave, Gardena, CA 90047', lat: 33.939, lng: -118.309,
    notes: '', driveTimeMinutes: 13, createdAt: fmt(addDays(today, -44)) },
  { id: 'j28', customerId: 'cust20', cleanerIds: ['c3', 'c4'],
    scheduledDate: fmt(addDays(today, -24)), scheduledTime: '11:00', estimatedDuration: 120,
    status: 'completed', serviceType: 'standard', price: 135, paid: true, paymentMethod: 'cash',
    address: '3401 Sepulveda Blvd, Manhattan Beach, CA 90266', lat: 33.878, lng: -118.377,
    notes: '', driveTimeMinutes: 17, createdAt: fmt(addDays(today, -28)) },
  { id: 'j29', customerId: 'cust21', cleanerIds: ['c7', 'c8'],
    scheduledDate: fmt(addDays(today, -30)), scheduledTime: '09:30', estimatedDuration: 120,
    status: 'completed', serviceType: 'standard', price: 125, paid: true, paymentMethod: 'venmo',
    address: '520 W Imperial Hwy, Hawthorne, CA 90250', lat: 33.922, lng: -118.341,
    notes: '', driveTimeMinutes: 12, createdAt: fmt(addDays(today, -35)) },
  { id: 'j30', customerId: 'cust22', cleanerIds: ['c9', 'c10'],
    scheduledDate: fmt(addDays(today, -34)), scheduledTime: '08:00', estimatedDuration: 90,
    status: 'completed', serviceType: 'airbnb', price: 145, paid: true, paymentMethod: 'zelle',
    address: '11400 Del Amo Blvd, Lakewood, CA 90715', lat: 33.845, lng: -118.093,
    notes: '', driveTimeMinutes: 7, createdAt: fmt(addDays(today, -38)) },
  { id: 'j31', customerId: 'cust23', cleanerIds: ['c3', 'c4'],
    scheduledDate: fmt(addDays(today, -22)), scheduledTime: '10:30', estimatedDuration: 150,
    status: 'completed', serviceType: 'standard', price: 155, paid: true, paymentMethod: 'venmo',
    address: '401 N Pacific Coast Hwy, Redondo Beach, CA 90277', lat: 33.856, lng: -118.388,
    notes: '', driveTimeMinutes: 14, createdAt: fmt(addDays(today, -26)) },

  // ── April completed jobs — bulk history for healthy revenue / analytics ──────
  // April 2
  { id: 'j32', customerId: 'cust4', cleanerIds: ['c1', 'c2'],
    scheduledDate: fmt(addDays(today, -26)), scheduledTime: '09:00', estimatedDuration: 150,
    status: 'completed', serviceType: 'standard', price: 175, paid: true, paymentMethod: 'zelle',
    address: '321 Atlantic Ave, Long Beach, CA 90807', lat: 33.827, lng: -118.178,
    notes: 'Bi-weekly', driveTimeMinutes: 10, createdAt: fmt(addDays(today, -30)) },
  { id: 'j33', customerId: 'cust5', cleanerIds: ['c3', 'c4'],
    scheduledDate: fmt(addDays(today, -26)), scheduledTime: '10:00', estimatedDuration: 120,
    status: 'completed', serviceType: 'airbnb', price: 195, paid: true, paymentMethod: 'venmo',
    address: '654 Hawthorne Blvd, Redondo Beach, CA 90278', lat: 33.862, lng: -118.367,
    notes: 'Airbnb turnaround', driveTimeMinutes: 16, createdAt: fmt(addDays(today, -30)) },
  { id: 'j34', customerId: 'cust7', cleanerIds: ['c7', 'c8'],
    scheduledDate: fmt(addDays(today, -26)), scheduledTime: '08:00', estimatedDuration: 300,
    status: 'completed', serviceType: 'move-out', price: 380, paid: true, paymentMethod: 'zelle',
    address: '147 Aviation Blvd, El Segundo, CA 90245', lat: 33.919, lng: -118.403,
    notes: 'Move-out clean', driveTimeMinutes: 7, createdAt: fmt(addDays(today, -30)) },
  // April 8
  { id: 'j35', customerId: 'cust1', cleanerIds: ['c1', 'c2'],
    scheduledDate: fmt(addDays(today, -20)), scheduledTime: '09:00', estimatedDuration: 210,
    status: 'completed', serviceType: 'deep', price: 245, paid: true, paymentMethod: 'zelle',
    address: '1234 Ocean Blvd, Long Beach, CA 90802', lat: 33.763, lng: -118.189,
    notes: 'Bi-weekly deep clean', driveTimeMinutes: 8, createdAt: fmt(addDays(today, -24)) },
  { id: 'j36', customerId: 'cust3', cleanerIds: ['c3', 'c4'],
    scheduledDate: fmt(addDays(today, -20)), scheduledTime: '11:00', estimatedDuration: 120,
    status: 'completed', serviceType: 'airbnb', price: 185, paid: true, paymentMethod: 'venmo',
    address: '789 Rosecrans Ave, Manhattan Beach, CA 90266', lat: 33.886, lng: -118.399,
    notes: 'Airbnb turnaround', driveTimeMinutes: 22, createdAt: fmt(addDays(today, -24)) },
  { id: 'j37', customerId: 'cust8', cleanerIds: ['c5', 'c6'],
    scheduledDate: fmt(addDays(today, -20)), scheduledTime: '09:30', estimatedDuration: 120,
    status: 'completed', serviceType: 'standard', price: 145, paid: true, paymentMethod: 'cash',
    address: '258 Artesia Blvd, Compton, CA 90220', lat: 33.896, lng: -118.235,
    notes: '', driveTimeMinutes: 9, createdAt: fmt(addDays(today, -24)) },
  { id: 'j38', customerId: 'cust22', cleanerIds: ['c9', 'c10'],
    scheduledDate: fmt(addDays(today, -20)), scheduledTime: '10:00', estimatedDuration: 90,
    status: 'completed', serviceType: 'airbnb', price: 175, paid: true, paymentMethod: 'zelle',
    address: '11400 Del Amo Blvd, Lakewood, CA 90715', lat: 33.845, lng: -118.093,
    notes: 'Airbnb quick turnaround', driveTimeMinutes: 7, createdAt: fmt(addDays(today, -24)) },
  // April 15
  { id: 'j39', customerId: 'cust4', cleanerIds: ['c1', 'c2'],
    scheduledDate: fmt(addDays(today, -13)), scheduledTime: '09:00', estimatedDuration: 150,
    status: 'completed', serviceType: 'standard', price: 175, paid: true, paymentMethod: 'zelle',
    address: '321 Atlantic Ave, Long Beach, CA 90807', lat: 33.827, lng: -118.178,
    notes: 'Bi-weekly', driveTimeMinutes: 10, createdAt: fmt(addDays(today, -17)) },
  { id: 'j40', customerId: 'cust2', cleanerIds: ['c3', 'c4'],
    scheduledDate: fmt(addDays(today, -13)), scheduledTime: '10:00', estimatedDuration: 150,
    status: 'completed', serviceType: 'standard', price: 155, paid: true, paymentMethod: 'venmo',
    address: '456 Sepulveda Blvd, Torrance, CA 90505', lat: 33.831, lng: -118.346,
    notes: '', driveTimeMinutes: 12, createdAt: fmt(addDays(today, -17)) },
  { id: 'j41', customerId: 'cust19', cleanerIds: ['c5', 'c6'],
    scheduledDate: fmt(addDays(today, -13)), scheduledTime: '08:30', estimatedDuration: 240,
    status: 'completed', serviceType: 'deep', price: 295, paid: true, paymentMethod: 'zelle',
    address: '6220 S Western Ave, Gardena, CA 90047', lat: 33.939, lng: -118.309,
    notes: 'Monthly deep clean', driveTimeMinutes: 13, createdAt: fmt(addDays(today, -17)) },
  { id: 'j42', customerId: 'cust14', cleanerIds: ['c7', 'c8'],
    scheduledDate: fmt(addDays(today, -13)), scheduledTime: '11:00', estimatedDuration: 90,
    status: 'completed', serviceType: 'airbnb', price: 165, paid: true, paymentMethod: 'venmo',
    address: '501 Manchester Ave, Inglewood, CA 90301', lat: 33.958, lng: -118.374,
    notes: 'Near SoFi', driveTimeMinutes: 15, createdAt: fmt(addDays(today, -17)) },
  { id: 'j43', customerId: 'cust16', cleanerIds: ['c9', 'c10'],
    scheduledDate: fmt(addDays(today, -13)), scheduledTime: '09:00', estimatedDuration: 120,
    status: 'completed', serviceType: 'standard', price: 155, paid: true, paymentMethod: 'cash',
    address: '15200 Alondra Blvd, Norwalk, CA 90650', lat: 33.902, lng: -118.081,
    notes: 'Bi-weekly', driveTimeMinutes: 12, createdAt: fmt(addDays(today, -17)) },
  // April 22
  { id: 'j44', customerId: 'cust6', cleanerIds: ['c1', 'c2'],
    scheduledDate: fmt(addDays(today, -6)), scheduledTime: '08:00', estimatedDuration: 300,
    status: 'completed', serviceType: 'move-out', price: 380, paid: true, paymentMethod: 'zelle',
    address: '987 Cherry Ave, Long Beach, CA 90813', lat: 33.801, lng: -118.181,
    notes: 'Move-out clean', driveTimeMinutes: 14, createdAt: fmt(addDays(today, -10)) },
  { id: 'j45', customerId: 'cust20', cleanerIds: ['c3', 'c4'],
    scheduledDate: fmt(addDays(today, -6)), scheduledTime: '11:00', estimatedDuration: 120,
    status: 'completed', serviceType: 'standard', price: 155, paid: true, paymentMethod: 'venmo',
    address: '3401 Sepulveda Blvd, Manhattan Beach, CA 90266', lat: 33.878, lng: -118.377,
    notes: 'Bi-weekly', driveTimeMinutes: 17, createdAt: fmt(addDays(today, -10)) },
  { id: 'j46', customerId: 'cust11', cleanerIds: ['c5', 'c6'],
    scheduledDate: fmt(addDays(today, -6)), scheduledTime: '09:00', estimatedDuration: 150,
    status: 'completed', serviceType: 'standard', price: 155, paid: true, paymentMethod: 'venmo',
    address: '852 Inglewood Ave, Hawthorne, CA 90250', lat: 33.916, lng: -118.352,
    notes: '', driveTimeMinutes: 14, createdAt: fmt(addDays(today, -10)) },
  // April 25
  { id: 'j47', customerId: 'cust7', cleanerIds: ['c7', 'c8'],
    scheduledDate: fmt(addDays(today, -3)), scheduledTime: '08:00', estimatedDuration: 360,
    status: 'completed', serviceType: 'post-construction', price: 425, paid: true, paymentMethod: 'zelle',
    address: '147 Aviation Blvd, El Segundo, CA 90245', lat: 33.919, lng: -118.403,
    notes: 'Post-construction clean', driveTimeMinutes: 7, createdAt: fmt(addDays(today, -7)) },
  { id: 'j48', customerId: 'cust10', cleanerIds: ['c9', 'c10'],
    scheduledDate: fmt(addDays(today, -3)), scheduledTime: '09:00', estimatedDuration: 210,
    status: 'completed', serviceType: 'deep', price: 265, paid: true, paymentMethod: 'venmo',
    address: '741 Lakewood Blvd, Lakewood, CA 90712', lat: 33.852, lng: -118.120,
    notes: 'Monthly deep clean', driveTimeMinutes: 6, createdAt: fmt(addDays(today, -7)) },
  { id: 'j49', customerId: 'cust1', cleanerIds: ['c1', 'c2'],
    scheduledDate: fmt(addDays(today, -3)), scheduledTime: '11:30', estimatedDuration: 150,
    status: 'completed', serviceType: 'standard', price: 165, paid: true, paymentMethod: 'zelle',
    address: '1234 Ocean Blvd, Long Beach, CA 90802', lat: 33.763, lng: -118.189,
    notes: '', driveTimeMinutes: 8, createdAt: fmt(addDays(today, -7)) },
...
export const PAYMENTS: Payment[] = [
  ...
  { id: 'p6', jobId: 'j12', customerId: 'cust1', cleanerIds: ['c1', 'c2'],
    ...
    month: fmt(addDays(today, -14)).slice(0, 7) },
  // April 2 batch
  { id: 'p7',  jobId: 'j32', customerId: 'cust4',  cleanerIds: ['c1', 'c2'],
    amount: 175, method: 'zelle', status: 'confirmed',
    confirmationNote: 'Zelle from Michael Davis', receivedAt: fmt(addDays(today, -26)) + 'T16:30:00',
    month: fmt(addDays(today, -26)).slice(0, 7) },
  { id: 'p8',  jobId: 'j33', customerId: 'cust5',  cleanerIds: ['c3', 'c4'],
    amount: 195, method: 'venmo', status: 'confirmed',
    confirmationNote: 'Venmo from Jennifer Park', receivedAt: fmt(addDays(today, -26)) + 'T15:00:00',
    month: fmt(addDays(today, -26)).slice(0, 7) },
  { id: 'p9',  jobId: 'j34', customerId: 'cust7',  cleanerIds: ['c7', 'c8'],
    amount: 380, method: 'zelle', status: 'confirmed',
    confirmationNote: 'Zelle from Amanda Wilson — move-out', receivedAt: fmt(addDays(today, -26)) + 'T14:00:00',
    month: fmt(addDays(today, -26)).slice(0, 7) },
  // April 8 batch
  { id: 'p10', jobId: 'j35', customerId: 'cust1',  cleanerIds: ['c1', 'c2'],
    amount: 245, method: 'zelle', status: 'confirmed',
    confirmationNote: 'Zelle from Sarah Mitchell', receivedAt: fmt(addDays(today, -20)) + 'T16:00:00',
    month: fmt(addDays(today, -20)).slice(0, 7) },
  { id: 'p11', jobId: 'j36', customerId: 'cust3',  cleanerIds: ['c3', 'c4'],
    amount: 185, method: 'venmo', status: 'confirmed',
    confirmationNote: 'Venmo from Lisa Thompson', receivedAt: fmt(addDays(today, -20)) + 'T15:30:00',
    month: fmt(addDays(today, -20)).slice(0, 7) },
  { id: 'p12', jobId: 'j37', customerId: 'cust8',  cleanerIds: ['c5', 'c6'],
    amount: 145, method: 'cash', status: 'confirmed',
    confirmationNote: 'Cash — Kevin Martinez', receivedAt: fmt(addDays(today, -20)) + 'T14:00:00',
    month: fmt(addDays(today, -20)).slice(0, 7) },
  { id: 'p13', jobId: 'j38', customerId: 'cust22', cleanerIds: ['c9', 'c10'],
    amount: 175, method: 'zelle', status: 'confirmed',
    confirmationNote: 'Zelle from Derek Oluwafemi', receivedAt: fmt(addDays(today, -20)) + 'T13:00:00',
    month: fmt(addDays(today, -20)).slice(0, 7) },
  // April 15 batch
  { id: 'p14', jobId: 'j39', customerId: 'cust4',  cleanerIds: ['c1', 'c2'],
    amount: 175, method: 'zelle', status: 'confirmed',
    confirmationNote: 'Zelle from Michael Davis', receivedAt: fmt(addDays(today, -13)) + 'T17:00:00',
    month: fmt(addDays(today, -13)).slice(0, 7) },
  { id: 'p15', jobId: 'j40', customerId: 'cust2',  cleanerIds: ['c3', 'c4'],
    amount: 155, method: 'venmo', status: 'confirmed',
    confirmationNote: 'Venmo from Robert Chen', receivedAt: fmt(addDays(today, -13)) + 'T15:00:00',
    month: fmt(addDays(today, -13)).slice(0, 7) },
  { id: 'p16', jobId: 'j41', customerId: 'cust19', cleanerIds: ['c5', 'c6'],
    amount: 295, method: 'zelle', status: 'confirmed',
    confirmationNote: 'Zelle from Elena Vasquez', receivedAt: fmt(addDays(today, -13)) + 'T14:00:00',
    month: fmt(addDays(today, -13)).slice(0, 7) },
  { id: 'p17', jobId: 'j42', customerId: 'cust14', cleanerIds: ['c7', 'c8'],
    amount: 165, method: 'venmo', status: 'confirmed',
    confirmationNote: 'Venmo from Marcus Webb', receivedAt: fmt(addDays(today, -13)) + 'T13:30:00',
    month: fmt(addDays(today, -13)).slice(0, 7) },
  { id: 'p18', jobId: 'j43', customerId: 'cust16', cleanerIds: ['c9', 'c10'],
    amount: 155, method: 'cash', status: 'confirmed',
    confirmationNote: 'Cash — Tony Castillo', receivedAt: fmt(addDays(today, -13)) + 'T12:00:00',
    month: fmt(addDays(today, -13)).slice(0, 7) },
  // April 22 batch
  { id: 'p19', jobId: 'j44', customerId: 'cust6',  cleanerIds: ['c1', 'c2'],
    amount: 380, method: 'zelle', status: 'confirmed',
    confirmationNote: 'Zelle from William Foster — move-out', receivedAt: fmt(addDays(today, -6)) + 'T15:00:00',
    month: fmt(addDays(today, -6)).slice(0, 7) },
  { id: 'p20', jobId: 'j45', customerId: 'cust20', cleanerIds: ['c3', 'c4'],
    amount: 155, method: 'venmo', status: 'confirmed',
    confirmationNote: 'Venmo from Thomas Kim', receivedAt: fmt(addDays(today, -6)) + 'T14:30:00',
    month: fmt(addDays(today, -6)).slice(0, 7) },
  { id: 'p21', jobId: 'j46', customerId: 'cust11', cleanerIds: ['c5', 'c6'],
    amount: 155, method: 'venmo', status: 'confirmed',
    confirmationNote: 'Venmo from Stephanie Garcia', receivedAt: fmt(addDays(today, -6)) + 'T13:00:00',
    month: fmt(addDays(today, -6)).slice(0, 7) },
  // April 25 batch
  { id: 'p22', jobId: 'j47', customerId: 'cust7',  cleanerIds: ['c7', 'c8'],
    amount: 425, method: 'zelle', status: 'confirmed',
    confirmationNote: 'Zelle from Amanda Wilson — post-construction', receivedAt: fmt(addDays(today, -3)) + 'T17:00:00',
    month: fmt(addDays(today, -3)).slice(0, 7) },
  { id: 'p23', jobId: 'j48', customerId: 'cust10', cleanerIds: ['c9', 'c10'],
    amount: 265, method: 'venmo', status: 'confirmed',
    confirmationNote: 'Venmo from Christopher Lee', receivedAt: fmt(addDays(today, -3)) + 'T16:00:00',
    month: fmt(addDays(today, -3)).slice(0, 7) },
  { id: 'p24', jobId: 'j49', customerId: 'cust1',  cleanerIds: ['c1', 'c2'],
    amount: 165, method: 'zelle', status: 'confirmed',
    confirmationNote: 'Zelle from Sarah Mitchell', receivedAt: fmt(addDays(today, -3)) + 'T15:00:00',
    month: fmt(addDays(today, -3)).slice(0, 7) },
]
