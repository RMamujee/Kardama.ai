...
export const CLEANERS: Cleaner[] = [
  {
    ...
    status: 'cleaning', availableHours: {
  ...
  },
  {
    ...
    status: 'en-route', availableHours: {
      Mon: { start: '08:00', end: '17:00' }, Tue: { start: '08:00', end: '17:00' },
      Wed: { start: '08:00', end: '17:00' }, Thu: { start: '08:00', end: '17:00' },
      Fri: { start: '08:00', end: '17:00' }, Sat: { start: '09:00', end: '14:00' }, Sun: null
    },
  ...
  },
  {
    ...
    status: 'off-duty', availableHours: {
      Mon: null, Tue: { start: '08:00', end: '17:00' },
      Wed: { start: '08:00', end: '17:00' }, Thu: { start: '08:00', end: '17:00' },
      Fri: { start: '08:00', end: '17:00' }, Sat: { start: '08:00', end: '13:00' }, Sun: null
    },
    specialties: ['move-out', 'deep-clean', 'post-construction'], reliabilityScore: 97,
    currentJobId: null, teamId: 'team-d', color: '#a855f7'
  },
  {
...
export const JOBS: Job[] = [
  { id: 'j1', customerId: 'cust1', cleanerIds: ['c1', 'c2'],
    scheduledDate: fmt(today), scheduledTime: '09:00', estimatedDuration: 180,
    status: 'in-progress', serviceType: 'standard', price: 165, paid: false,
    address: '1234 Ocean Blvd, Long Beach, CA 90802', lat: 33.763, lng: -118.189,
    notes: '', driveTimeMinutes: 8, createdAt: fmt(addDays(today, -3)) },
  { id: 'j2', customerId: 'cust2', cleanerIds: ['c3', 'c4'],
    scheduledDate: fmt(today), scheduledTime: '10:00', estimatedDuration: 150,
    status: 'scheduled', serviceType: 'standard', price: 145, paid: false,
    address: '456 Sepulveda Blvd, Torrance, CA 90505', lat: 33.831, lng: -118.346,
    notes: '', driveTimeMinutes: 12, createdAt: fmt(addDays(today, -2)) },
  { id: 'j3', customerId: 'cust3', cleanerIds: ['c3', 'c4'],
    ...
    address: '789 Rosecrans Ave, Manhattan Beach, CA 90266', lat: 33.886, lng: -118.399,
    notes: 'Airbnb turnaround', driveTimeMinutes: 22, createdAt: fmt(addDays(today, -1)) },
  { id: 'j4', customerId: 'cust4', cleanerIds: ['c1', 'c2'],
    scheduledDate: fmt(addDays(today, 1)), scheduledTime: '09:00', estimatedDuration: 240,
    status: 'scheduled', serviceType: 'deep', price: 285, paid: false,
    address: '321 Atlantic Ave, Long Beach, CA 90807', lat: 33.827, lng: -118.178,
    notes: '4BD deep clean', driveTimeMinutes: 10, createdAt: fmt(addDays(today, -1)) },
  { id: 'j5', customerId: 'cust1', cleanerIds: ['c1', 'c2'],
    scheduledDate: fmt(addDays(today, 2)), scheduledTime: '09:00', estimatedDuration: 180,
    status: 'scheduled', serviceType: 'standard', price: 165, paid: false,
    address: '1234 Ocean Blvd, Long Beach, CA 90802', lat: 33.763, lng: -118.189,
    notes: '', driveTimeMinutes: 8, createdAt: fmt(addDays(today, -2)) },
  { id: 'j6', customerId: 'cust5', cleanerIds: ['c3', 'c4'],
    scheduledDate: fmt(addDays(today, 3)), scheduledTime: '10:00', estimatedDuration: 210,
    status: 'scheduled', serviceType: 'deep', price: 245, paid: false,
    address: '654 Hawthorne Blvd, Redondo Beach, CA 90278', lat: 33.862, lng: -118.367,
    notes: '', driveTimeMinutes: 15, createdAt: fmt(addDays(today, -1)) },
  ...
  { id: 'j10', customerId: 'cust7', cleanerIds: ['c7', 'c8'],
    scheduledDate: fmt(addDays(today, 5)), scheduledTime: '09:00', estimatedDuration: 180,
    status: 'scheduled', serviceType: 'standard', price: 155, paid: false,
    address: '147 Aviation Blvd, El Segundo, CA 90245', lat: 33.919, lng: -118.403,
    notes: 'Weekly regular', driveTimeMinutes: 7, createdAt: fmt(addDays(today, -1)) },
